...
const SideBarStats = ({ players }: { players: Adventurer[] }) => {
    ...
    return <div className="custom_bg-gray rounded-sm p-3 m-1 text-center grid grid-flow-row-dense md:grid-cols-2 md:grid-rows-4 lg:grid-cols-4 lg:grid-rows-2 justify-content items-center text-white gap-x-0.5">
        <div className="col-span-1 row-span-1 grid grid-flow-row-dense grid-cols-1 grid-rows-3">
            ...
            <p className="row-span-2 text-xl">{player.stats.strength}</p>
        </div>
        <div className="col-span-1 row-span-1 grid grid-flow-row-dense grid-cols-1 grid-rows-3">
            <strong>DXT</strong>
            <p className="row-span-2 text-xl">{player.stats.dexterity}</p>
        </div>
        <div className="col-span-1 row-span-1 grid grid-flow-row-dense grid-cols-1 grid-rows-3">
            <strong>CONST</strong>
            <p className="row-span-2 text-xl">{player.stats.constitution}</p>
        </div>
        <div className="col-span-1 row-span-1 grid grid-flow-row-dense grid-cols-1 grid-rows-3">
            <strong>INTG</strong>
            <p className="row-span-2 text-xl">{player.stats.intelligence}</p>
        </div>
        <div className="col-span-1 row-span-1 grid grid-flow-row-dense grid-cols-1 grid-rows-3">
            <strong>WSDM</strong>
            <p className="row-span-2 text-xl">{player.stats.wisdom}</p>
        </div>
        <div className="col-span-1 row-span-1 grid grid-flow-row-dense grid-cols-1 grid-rows-3">
            <strong>CHRS</strong>
            <p className="row-span-2 text-xl">{player.stats.charisma}</p>
        </div>
        <div className="col-span-1 row-span-1 grid grid-flow-row-dense grid-cols-1 grid-rows-3">
            <strong>INIT</strong>
            <p className="row-span-2 text-xl">{player.vigor.initiative}</p>
        </div>
        <div className="col-span-1 row-span-1 grid grid-flow-row-dense grid-cols-1 grid-rows-3">
            <strong>SPD</strong>
            <p className="row-span-2 text-xl">{player.vigor.speed}</p>
        </div>
    </div>
}
...
const SideBarHealth = ({ players }: { players: Adventurer[] }) => {
    ...
    return <div className="custom_bg-gray h-full rounded-sm p-3 m-1 text-center grid grid-flow-row-dense grid-cols-2 grid-rows-1 justify-content items-center text-white gap-x-0.5">
        <div className="col-span-1 row-span-1">
            <strong>HP</strong>
            <p>{player.hitPoints.currentHp}/{player.hitPoints.maxHp}</p>
        </div>
        <div className="col-span-1 row-span-1">
            <strong>ARMCL</strong>
            <p>{player.vigor.armorClass}</p>
        </div>
    </div>
}
    ...
    return <div className="text-center overflow-auto overscroll-auto scrollbar-thumb:!rounded h-full no-scrollbar">
        ...
        <div className="grid grid-flow-row-dense grid-cols-3 grid-rows-1">
            <div className="col-span-2 row-span-1">
                <strong className="text-white text-2xl">HP</strong>
                <SideBarHealth players={players}></SideBarHealth>
            </div>
            <div className="col-span-1 row-span-2">
                <strong className="text-white text-2xl">Coins</strong>
