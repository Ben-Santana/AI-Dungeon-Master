        ...
        <div className="flex-auto p-1 rounded-lg border-2 border-gray-800">
          <div className="w-full flex flex-row flex-row-reverse custom_bg-light-beige rounded-lg gap-3 p-5 items-end">
            ...
            <div className="self-center w-full h-full">
              ...
              {/* <textarea className="w-full text-black-900 text-balance focus:outline-none" name="Input" id=""></textarea> */}
            </div>
          </div>
        </div>
        <div className="flex-initial h-full custom_bg-light-beige rounded-lg overflow-auto overscroll-auto scrollbar-thumb:!rounded no-scrollbar">
